...
export class FocusTrap {
    constructor(element) {
        ...
        Object.defineProperty(this, "previousFocus", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
 ...
 */
export const createKeyboardNavigation = ({ onEnter, onSpace, onEscape, onArrowUp, onArrowDown, onArrowLeft, onArrowRight, }) => {
    return (event) => {
        switch (event.key) {
            case 'Enter':
                event.preventDefault();
