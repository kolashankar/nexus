...
const createMindReadingEffect = (element: HTMLElement) => {
...
const createReflexEffect = (element: HTMLElement) => {
...
const createAuraEffect = (element: HTMLElement, color: string) => {
...
const createDangerSenseEffect = (element: HTMLElement) => {
  const pulseCount = 3;
...
const createInvisibilityEffect = (element: HTMLElement) => {
...
const createShieldEffect = (element: HTMLElement, color: string) => {
...
const createVisionEffect = (element: HTMLElement) => {
...
const createTechEffect = (element: HTMLElement) => {
  // Binary rain effect
  for (let i = 0; i < 20; i++) {
    setTimeout(() => {
...
const createTimeSlowEffect = (element: HTMLElement) => {
...
const createHealingTouchEffect = (element: HTMLElement) => {
  createCombatParticles(element, 30, '#10b981');
  createAuraEffect(element, '#10b981');
};

const createProbabilityEffect = (element: HTMLElement) => {
...
const createEmpathicEffect = (element: HTMLElement, color: string) => {
  // Heart particles
  for (let i = 0; i < 10; i++) {
    setTimeout(() => {
...
const createShadowWalkEffect = (element: HTMLElement) => {
...
const createCharmEffect = (element: HTMLElement, color: string) => {
  createAuraEffect(element, color);
  createCombatParticles(element, 20, '#ec4899');
};

const createCombatSupremacyEffect = (element: HTMLElement) => {
  element.classList.add('animate-shake');
  createCombatParticles(element, 40, '#ef4444');
  setTimeout(() => element.classList.remove('animate-shake'), 500);
};

const createMemoryEffect = (element: HTMLElement) => {
...
const createFutureGlimpseEffect = (element: HTMLElement) => {
...
const createRealityBendEffect = (element: HTMLElement) => {
...
const createKarmaTransferEffect = (element: HTMLElement) => {
  // Karma symbol and energy flow
  createCombatParticles(element, 50, '#8b5cf6');
  createEnergyBurst(element, '#8b5cf6');
};

const createSoulBondEffect = (element: HTMLElement, color: string) => {
...
const createTemporalEchoEffect = (element: HTMLElement) => {
  // Create ghost copies
  for (let i = 0; i < 3; i++) {
    setTimeout(() => {
      const echo = element.cloneNode(true) as HTMLElement;
...
const createOmniscienceEffect = (element: HTMLElement) => {
...
const createAscensionEffect = (element: HTMLElement) => {
