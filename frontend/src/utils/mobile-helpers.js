...
export const getSafeAreaInsets = () => {
    const getInset = (side) => {
        const value = getComputedStyle(document.documentElement).getPropertyValue(`--safe-area-inset-${side}`);
...
export class TouchGestureDetector {
    constructor(element) {
        ...
        Object.defineProperty(this, "onSwipeLeft", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onSwipeRight", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onSwipeUp", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onSwipeDown", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
export class PullToRefresh {
    constructor(element, threshold = 80) {
        ...
        Object.defineProperty(this, "onPull", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onThresholdReached", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onRelease", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
