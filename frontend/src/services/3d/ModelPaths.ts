...
export const MODEL_PATHS = {
  ...
  characters: {
    male: {
      base: '/models/characters/male/base.glb',
      athletic: '/models/characters/male/athletic.glb',
      heavy: '/models/characters/male/heavy.glb'
    },
    female: {
      base: '/models/characters/female/base.glb',
      athletic: '/models/characters/female/athletic.glb',
      heavy: '/models/characters/female/heavy.glb'
    }
  },
  ...
  // Robot Models
  robots: {
    worker: '/models/robots/worker_bot.glb',
    combat: '/models/robots/combat_bot.glb',
    scout: '/models/robots/scout_bot.glb',
    guardian: '/models/robots/guardian_bot.glb',
    assault: '/models/robots/assault_bot.glb',
    tactical: '/models/robots/tactical_bot.glb',
    hacker: '/models/robots/hacker_bot.glb',
    medic: '/models/robots/medic_bot.glb',
    harvester: '/models/robots/harvester_bot.glb',
    trader: '/models/robots/trader_bot.glb'
  },

  // Environment
  environment: {
    buildings: {
      tower: '/models/environment/buildings/tower.glb',
      warehouse: '/models/environment/buildings/warehouse.glb',
      shop: '/models/environment/buildings/shop.glb',
      headquarters: '/models/environment/buildings/headquarters.glb'
    },
    props: {
      terminal: '/models/environment/props/terminal.glb',
      container: '/models/environment/props/container.glb',
      vehicle: '/models/environment/props/vehicle.glb'
    },
    terrain: {
      ground: '/models/environment/terrain/ground.glb',
  ...
  // Placeholder Models (simple geometries as fallbacks)
  placeholders: {
...
export const TEXTURE_PATHS = {
  ...
  environment: {
    ground: '/textures/environment/ground/',
...
export const ASSET_COLLECTIONS = {
  ...
  // Environment assets
  worldEnvironment: [
    MODEL_PATHS.environment.terrain.ground,
 ...
 */
export function getModelPath(category: string, type: string): string | undefined {
 ...
 */
export function getCategoryPaths(category: string): string[] {
  const paths: any = MODEL_PATHS;
