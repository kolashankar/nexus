...
test.describe('Gameplay E2E Tests', () => {
  ...
  test('should perform a game action (help)', async ({ page }) => {
    ...
    // Select help action
    await page.click('button:has-text("Help Player")');
  ...
  test('should view skill tree', async ({ page }) => {
    ...
    await page.click('button:has-text("Hacking")');
  ...
  test('should navigate to marketplace', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Robots")')).toBeVisible();
  ...
  test('should view leaderboards', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Karma")')).toBeVisible();
