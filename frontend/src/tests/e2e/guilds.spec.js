...
test.describe('Guilds E2E Tests', () => {
    ...
    test('should join a guild', async ({ page }) => {
        ...
        const openGuild = page
            ...
            .filter({ hasText: 'Open' })
            .first();
        if ((await openGuild.count()) > 0) {
            await openGuild.click();
            // Click join button
            await page.click('button:has-text("Join Guild")');
            // Confirm join
    ...
    test('should view guild wars', async ({ page }) => {
        ...
        await page.click('button:has-text("Wars")');
        // Verify wars section
    ...
    test('should leave guild', async ({ page }) => {
        ...
        // Click leave guild
        await page.click('button:has-text("Leave Guild")');
        // Confirm leaving
