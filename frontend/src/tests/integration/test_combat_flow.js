...
describe('Combat Flow Integration Tests', () => {
    ...
    describe('Combat Challenge', () => {
        it('should challenge another player to combat', async () => {
            const response = await axios.post(`${API_URL}/api/combat/challenge`, {
        ...
        it('should accept combat challenge', async () => {
            const response = await axios.post(`${API_URL}/api/combat/accept`, {
                combat_id: combatId,
            }, {
                headers: { Authorization: `Bearer ${authToken2}` },
            });
    ...
    describe('Combat Actions', () => {
        it('should perform attack action', async () => {
            const response = await axios.post(`${API_URL}/api/combat/action`, {
                combat_id: combatId,
                action_type: 'attack',
                target: player2Id,
            }, {
    ...
    describe('Arena Mode', () => {
        it('should join arena queue', async () => {
            const response = await axios.post(`${API_URL}/api/combat/arena/join`, {}, {
                headers: { Authorization: `Bearer ${authToken1}` },
            });
            expect(response.status).toBe(200);
