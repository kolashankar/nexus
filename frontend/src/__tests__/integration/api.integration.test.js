...
const server = setupServer(rest.post('/api/auth/login', (req, res, ctx) => {
    return res(ctx.json({
...
describe('API Integration Tests', () => {
    ...
    describe('Protected Routes', () => {
        ...
        test('returns 401 when token missing', async () => {
            ...
            try {
                await apiClient.get('/player/profile');
    ...
    describe('Error Handling', () => {
        test('handles network errors', async () => {
            server.use(rest.get('/api/player/profile', (req, res) => {
        ...
        test('handles server errors', async () => {
            server.use(rest.get('/api/player/profile', (req, res, ctx) => {
