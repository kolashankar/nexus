...
describe('QuestDetails', () => {
  it('renders quest information', () => {
    render(<QuestDetails quest={mockQuest} />);
  ...
  it('calls onAccept when accept button is clicked', () => {
    ...
    render(<QuestDetails quest={mockQuest} onAccept={mockOnAccept} />);
  ...
  it('calls onAbandon when abandon button is clicked', () => {
    ...
    render(<QuestDetails quest={activeQuest} onAbandon={mockOnAbandon} />);
