    ...
    try {
      ...
      if (response.ok) {
        toast.success('Quest Accepted', {
          description: 'Hidden quest accepted successfully!'
        });
        fetchHiddenQuests();
      }
    } catch (error) {
      toast.error('Failed to accept', {
        description: 'Could not accept quest',
        variant: 'destructive'
      });
    }
  };
        ...
        {hints.length === 0 ? (
          ...
          <div className="space-y-3">
            {hints.map((hint, index) => (
              <div key={index} className="border rounded-lg p-4 bg-purple-50 dark:bg-purple-950">
