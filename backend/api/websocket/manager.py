...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, player_id: str, username: str):
        ...
        logger.info(f"Player {username} ({player_id}) connected. Total online: {len(self.active_connections)}")
    ...
    def disconnect(self, player_id: str):
        ...
        if player_id in self.active_connections:
            username = self.player_metadata.get(player_id, {}).get("username", "Unknown")
            ...
            logger.info(f"Player {username} ({player_id}) disconnected. Total online: {len(self.active_connections)}")
