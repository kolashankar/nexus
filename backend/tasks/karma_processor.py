...
class KarmaProcessor:
    ...
    def add_to_queue(self, evaluation_data: Dict[str, Any]) -> None:
        ...
        logger.info(f"Added karma evaluation to queue. Queue size: {len(self.queue)}")
    ...
    async def process_queue(self) -> None:
        ...
        logger.info(f"Starting karma queue processing. Queue size: {len(self.queue)}")
    ...
    async def _process_item(self, item: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.info(f"Processed karma evaluation: {result.karma_change} karma")
