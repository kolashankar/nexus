...
class TestGuildMembership:
    ...
    def test_add_member_to_guild(self):
        ...
        assert any(m["player_id"] == "new_member" for m in updated_guild["members"])
    ...
    def test_new_member_has_recruit_rank(self):
        ...
        new_member = next(m for m in updated_guild["members"] if m["player_id"] == "new_member")
    ...
    def test_remove_member_from_guild(self):
        ...
        assert not any(m["player_id"] == "member1" for m in updated_guild["members"])
    ...
    def test_promote_member(self):
        ...
        member = next(m for m in updated_guild["members"] if m["player_id"] == "member1")
...
class TestGuildWars:
    ...
    def test_declare_war(self):
        ...
        updated_guild = service.declare_war(guild1, enemy_guild_id=guild2["_id"])
