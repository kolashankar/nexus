...
class Tournament(BaseModel):
    ...
    max_participants: int = Field(default=64, description="Maximum number of participants")
    min_participants: int = Field(default=8, description="Minimum participants to start")
    
    # Requirements
    min_level: Optional[int] = Field(None, description="Minimum player level")
    min_karma: Optional[int] = Field(None, description="Minimum karma requirement")
