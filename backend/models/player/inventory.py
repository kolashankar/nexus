...
class InventoryItem(BaseModel):
    ...
    acquired_at: datetime = Field(default_factory=datetime.utcnow, description='When item was acquired')
...
class PlayerInventory(BaseModel):
    ...
    last_updated: datetime = Field(default_factory=datetime.utcnow, description='Last inventory update')
...
class ItemUsageResponse(BaseModel):
    ...
    success: bool = Field(..., description='Whether item was used successfully')
    ...
    effect_description: str = Field(..., description='Description of item effect')
