...
class EventGenerator:
    ...
    POSITIVE_EVENTS = {
        EventType.GOLDEN_AGE: {
            ...
            "effects": [
                {"effect_type": "xp_boost", "value": 2.0, "duration_hours": 24.0, "description": "100% XP boost"},
                {"effect_type": "credits_boost", "value": 2.0, "duration_hours": 24.0, "description": "100% Credits boost"},
                {"effect_type": "karma_multiplier", "value": 1.5, "duration_hours": 24.0, "description": "50% more karma from good actions"}
            ],
            "duration_hours": 24.0,
        ...
        EventType.DIVINE_BLESSING: {
            ...
            "effects": [
                {"effect_type": "random_superpower", "value": 100, "duration_hours": 72.0, "description": "100 random players unlock a new superpower"},
                {"effect_type": "power_cooldown_reduction", "value": 0.5, "duration_hours": 48.0, "description": "50% faster superpower cooldowns"}
            ],
            "duration_hours": 48.0,
            "severity": EventSeverity.HIGH,
            "impact": "high"
        ...
        EventType.FESTIVAL_OF_LIGHT: {
            ...
            "effects": [
                {"effect_type": "special_marketplace", "value": 1, "duration_hours": 24.0, "description": "Festival Market opens with exclusive items"},
                {"effect_type": "market_discount", "value": 0.7, "duration_hours": 24.0, "description": "30% discount on all items"}
            ],
            "duration_hours": 24.0,
        ...
        EventType.THE_CONVERGENCE: {
            ...
            "effects": [
                {"effect_type": "trait_visibility", "value": 1, "duration_hours": 12.0, "description": "All hidden traits become visible"},
                {"effect_type": "insight_boost", "value": 1, "duration_hours": 12.0, "description": "Enhanced perception of other players"}
            ],
            "duration_hours": 12.0,
            "severity": EventSeverity.MEDIUM,
            "impact": "medium"
    ...
    NEGATIVE_EVENTS = {
        EventType.THE_PURGE: {
            ...
            "effects": [
                {"effect_type": "karma_disabled", "value": 1, "duration_hours": 24.0, "description": "No karma penalties for any actions"},
                {"effect_type": "pvp_rewards_doubled", "value": 2.0, "duration_hours": 24.0, "description": "Double rewards from PvP"}
            ],
            "duration_hours": 24.0,
        ...
        EventType.ECONOMIC_COLLAPSE: {
            ...
            "effects": [
                {"effect_type": "price_volatility", "value": 3.0, "duration_hours": 48.0, "description": "Prices change by ±50% randomly"},
                {"effect_type": "stock_market_crash", "value": 0.5, "duration_hours": 48.0, "description": "All stocks lose 50% value"},
                {"effect_type": "transaction_fee", "value": 1.2, "duration_hours": 48.0, "description": "20% fee on all transactions"}
            ],
            "duration_hours": 48.0,
            "severity": EventSeverity.HIGH,
            "impact": "high"
        ...
        EventType.DARK_ECLIPSE: {
            ...
            "effects": [
                {"effect_type": "vision_reduction", "value": 0.5, "duration_hours": 24.0, "description": "50% reduced vision range"},
                {"effect_type": "stealth_boost", "value": 2.0, "duration_hours": 24.0, "description": "100% stealth effectiveness"},
                {"effect_type": "darkness_damage", "value": 1.2, "duration_hours": 24.0, "description": "Dark actions deal 20% more damage"}
            ],
            "duration_hours": 24.0,
            "severity": EventSeverity.MEDIUM,
            "impact": "medium"
        ...
        EventType.JUDGMENT_DAY: {
            ...
            "effects": [
                {"effect_type": "judgment_targeting", "value": 100, "duration_hours": 72.0, "description": "Bottom 100 karma players receive penalties"},
                {"effect_type": "vice_amplification", "value": 1.5, "duration_hours": 72.0, "description": "All negative traits increased by 50%"},
                {"effect_type": "karma_drain", "value": 0.9, "duration_hours": 72.0, "description": "10% karma drain per day for evil players"}
            ],
            "duration_hours": 72.0,
            "severity": EventSeverity.CRITICAL,
            "impact": "world_changing"
    ...
    NEUTRAL_EVENTS = {
        EventType.METEOR_SHOWER: {
            ...
            "effects": [
                {"effect_type": "resource_spawn", "value": 1000, "duration_hours": 24.0, "description": "1000 rare resources spawn randomly"},
                {"effect_type": "crafting_boost", "value": 1.5, "duration_hours": 48.0, "description": "50% faster crafting"}
            ],
            "duration_hours": 24.0,
        ...
        EventType.GLITCH_IN_MATRIX: {
            ...
            "effects": [
                {"effect_type": "random_effects", "value": 1, "duration_hours": 12.0, "description": "Random status effects every hour"},
                {"effect_type": "power_randomization", "value": 1, "duration_hours": 12.0, "description": "Powers may trigger randomly"},
                {"effect_type": "chaos_bonus", "value": 1.3, "duration_hours": 12.0, "description": "30% bonus to all random events"}
            ],
            "duration_hours": 12.0,
            "severity": EventSeverity.MEDIUM,
            "impact": "medium"
        ...
        EventType.ROBOT_UPRISING: {
            ...
            "effects": [
                {"effect_type": "robot_spawns", "value": 500, "duration_hours": 24.0, "description": "500 hostile robots spawn"},
                {"effect_type": "robot_drops", "value": 2.0, "duration_hours": 24.0, "description": "Double loot from defeated robots"},
                {"effect_type": "alliance_bonus", "value": 1.5, "duration_hours": 24.0, "description": "50% bonus when fighting in groups"}
            ],
            "duration_hours": 24.0,
            "severity": EventSeverity.HIGH,
            "impact": "high"
        ...
        EventType.TIME_ANOMALY: {
            ...
            "effects": [
                {"effect_type": "time_dilation", "value": 0.5, "duration_hours": 24.0, "description": "Random time speed changes (0.5x to 2x)"},
                {"effect_type": "instant_cooldowns", "value": 0.2, "duration_hours": 24.0, "description": "20% chance for instant cooldown reset"},
                {"effect_type": "quest_timer_chaos", "value": 1, "duration_hours": 24.0, "description": "Quest timers may extend or shrink"}
            ],
            "duration_hours": 24.0,
            "severity": EventSeverity.MEDIUM,
            "impact": "medium"
