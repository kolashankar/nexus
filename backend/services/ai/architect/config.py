...
class ArchitectConfig:
    ...
    # Trigger thresholds
    KARMA_SENSITIVITY = float(os.getenv("KARMA_SENSITIVITY", "1.0"))  # Multiplier for karma thresholds
    AUTO_TRIGGER_ENABLED = os.getenv("AUTO_TRIGGER_EVENTS", "true").lower() == "true"
    ...
    # Regional events
    REGIONAL_EVENTS_ENABLED = os.getenv("REGIONAL_EVENTS_ENABLED", "true").lower() == "true"
    REGIONAL_EVENT_FREQUENCY_HOURS = int(os.getenv("REGIONAL_EVENT_FREQUENCY", "12"))
    
    # Notification settings
    BROADCAST_EVENTS = os.getenv("BROADCAST_EVENTS", "true").lower() == "true"
    EVENT_NOTIFICATION_CHANNELS = os.getenv("EVENT_NOTIFICATION_CHANNELS", "websocket,email").split(",")
