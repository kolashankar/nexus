...
class CraftingService:
    ...
    async def get_recipes(
        ...
        for recipe in all_recipes:
            ...
            # Add unlocked status
            recipe["unlocked"] = player_level >= recipe.get("level_required", 0)
    ...
    async def craft_item(
        ...
        player_crafting_skill = player.get("traits", {}).get("engineering", 50) / 100
    ...
    async def dismantle_item(
        ...
        player_inventory = player.get("items", [])
        item = next((i for i in player_inventory if i.get("item_id") == item_id), None)
        ...
        player_inventory = [i for i in player_inventory if i.get("item_id") != item_id]
